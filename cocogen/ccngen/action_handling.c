...
enum ccn_action_id constructruletable_ids_table[] = {    CCNAC_ID_BUILDRULETABLE,     CCNAC_ID_CONVERTRAWRULES,     CCNAC_ID_ITERATERULETABLE,     CCNAC_ID_RULETEMPLATESTOREGEX,     CCNAC_ID_NULL, };
...
enum ccn_action_id semantic_ids_table[] = {    CCNAC_ID_BUILDSYMBOLTABLE,     CCNAC_ID_CONSTRUCTRULETABLE,     CCNAC_ID_CHECKEXISTANCE,     CCNAC_ID_UNWRAPSETEXPR,     CCNAC_ID_REACHABILITY,     CCNAC_ID_NULL, };
...
{CCN_ACTION_PHASE, CCNAC_ID_CONSTRUCTRULETABLE, "constructRuleTable", .phase = {NULL, NT_AST, constructruletable_ids_table, false, CCNAC_ID_CONSTRUCTRULETABLE,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_RULETEMPLATESTOREGEX, "ruleTemplatesToRegex", .traversal = {TRAV_RTTR,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_ITERATERULETABLE, "iterateRuleTable", .traversal = {TRAV_IRT,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_CONVERTRAWRULES, "convertRawRules", .traversal = {TRAV_CRR,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_BUILDRULETABLE, "buildRuleTable", .traversal = {TRAV_BRT,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENEMPTYNODEINITFUNCTIONS, "dynamicGenEmptyNodeInitFunctions", .traversal = {TRAV_DGEIF,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENEMPTYNODECONSTRUCTOR, "dynamicGenEmptyNodeConstructor", .traversal = {TRAV_DGENC,},},
...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENSHORTHAND, "dynamicGenShorthand", .traversal = {TRAV_DGSHT,},},
