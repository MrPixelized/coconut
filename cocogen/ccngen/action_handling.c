...
enum ccn_action_id semantic_ids_table[] = {    CCNAC_ID_BUILDSYMBOLTABLE,     CCNAC_ID_BUILDRULETABLE,     CCNAC_ID_CHECKEXISTANCE,     CCNAC_ID_UNWRAPSETEXPR,     CCNAC_ID_REACHABILITY,     CCNAC_ID_NULL, };
