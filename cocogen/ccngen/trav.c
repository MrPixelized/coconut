...
node_st *TRAVirules(node_st *node) {
    switch (NODE_TYPE(node)) {
        case NT_INODE:
            INODE_IRULES(node) = TRAVopt(INODE_IRULES(node));
            break;
            break;
        default:
            DBUG_ASSERT(false, "Current target has no child irules");
            break;
    }
...
node_st *TRAVnext(node_st *node) {
    switch (NODE_TYPE(node)) {
        ...
        case NT_ILIFETIME:
            ...
            break;
        case NT_RAW_RULE:
            RAW_RULE_NEXT(node) = TRAVopt(RAW_RULE_NEXT(node));
            break;
            break;
        case NT_FIELD:
            FIELD_NEXT(node) = TRAVopt(FIELD_NEXT(node));
            break;
            break;
        case NT_CHILD:
        ...
        case NT_STE:
            ...
            break;
        case NT_RTE:
            RTE_NEXT(node) = TRAVopt(RTE_NEXT(node));
            break;
            break;
        case NT_ITRAVDATA:
...
node_st *TRAVfields(node_st *node) {
    switch (NODE_TYPE(node)) {
        case NT_PATTERN:
            PATTERN_FIELDS(node) = TRAVopt(PATTERN_FIELDS(node));
            break;
            break;
        default:
            DBUG_ASSERT(false, "Current target has no child fields");
            break;
    }
...
node_st *TRAVrtable(node_st *node) {
    switch (NODE_TYPE(node)) {
        case NT_AST:
            AST_RTABLE(node) = TRAVopt(AST_RTABLE(node));
            break;
            break;
        default:
            DBUG_ASSERT(false, "Current target has no child rtable");
            break;
    }
...
node_st *TRAVrule(node_st *node) {
    switch (NODE_TYPE(node)) {
        case NT_RTE:
            RTE_RULE(node) = TRAVopt(RTE_RULE(node));
            break;
            break;
        default:
