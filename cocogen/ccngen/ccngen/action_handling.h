...
enum ccn_action_id {
    ...
    CCNAC_ID_RULETEMPLATESTOREGEX,
    CCNAC_ID_ITERATERULETABLE,
    CCNAC_ID_CONVERTRAWRULES,
    CCNAC_ID_BUILDRULETABLE,
    ...
    CCNAC_ID_DYNAMICGENEMPTYNODECONSTRUCTOR,
