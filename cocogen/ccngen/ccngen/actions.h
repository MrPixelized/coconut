...
struct ccn_node *PRTrte(struct ccn_node *node);
struct ccn_node *PRTste(struct ccn_node *node);
struct ccn_node *PRTchild(struct ccn_node *node);
struct ccn_node *PRTrule(struct ccn_node *node);
struct ccn_node *PRTfield(struct ccn_node *node);
struct ccn_node *PRTpattern(struct ccn_node *node);
struct ccn_node *PRTraw_rule(struct ccn_node *node);
...
ccn_node *USEsetreference(ccn_node *);
ccn_node *RTTRrte(ccn_node *);
ccn_node *RTTRrte(ccn_node *);
ccn_node *RTTRrule(ccn_node *);
ccn_node *RTTRrule(ccn_node *);
ccn_node *IRTast(ccn_node *);
ccn_node *IRTast(ccn_node *);
ccn_node *IRTrte(ccn_node *);
ccn_node *IRTrte(ccn_node *);
ccn_node *IRTrule(ccn_node *);
ccn_node *IRTrule(ccn_node *);
ccn_node *CRRast(ccn_node *);
ccn_node *CRRast(ccn_node *);
ccn_node *CRRrte(ccn_node *);
ccn_node *CRRrte(ccn_node *);
ccn_node *CRRraw_rule(ccn_node *);
ccn_node *CRRraw_rule(ccn_node *);
ccn_node *BRTast(ccn_node *);
ccn_node *BRTast(ccn_node *);
ccn_node *BRTinode(ccn_node *);
ccn_node *BRTinode(ccn_node *);
ccn_node *BRTraw_rule(ccn_node *);
ccn_node *BRTraw_rule(ccn_node *);
...
struct ccn_node *BSTrte(struct ccn_node *node);
struct ccn_node *BSTste(struct ccn_node *node);
struct ccn_node *BSTchild(struct ccn_node *node);
struct ccn_node *BSTrule(struct ccn_node *node);
struct ccn_node *BSTfield(struct ccn_node *node);
struct ccn_node *BSTpattern(struct ccn_node *node);
struct ccn_node *BSTraw_rule(struct ccn_node *node);
...
struct ccn_node *CEXrte(struct ccn_node *node);
struct ccn_node *CEXste(struct ccn_node *node);
struct ccn_node *CEXchild(struct ccn_node *node);
struct ccn_node *CEXrule(struct ccn_node *node);
struct ccn_node *CEXfield(struct ccn_node *node);
struct ccn_node *CEXpattern(struct ccn_node *node);
struct ccn_node *CEXraw_rule(struct ccn_node *node);
...
ccn_node *DGNCattribute(ccn_node *);
ccn_node *DGENCinode(ccn_node *);
ccn_node *DGENCinode(ccn_node *);
ccn_node *DGENCchild(ccn_node *);
ccn_node *DGENCchild(ccn_node *);
...
struct ccn_node *DGCTrte(struct ccn_node *node);
struct ccn_node *DGCTste(struct ccn_node *node);
struct ccn_node *DGCTchild(struct ccn_node *node);
struct ccn_node *DGCTrule(struct ccn_node *node);
struct ccn_node *DGCTfield(struct ccn_node *node);
struct ccn_node *DGCTpattern(struct ccn_node *node);
struct ccn_node *DGCTraw_rule(struct ccn_node *node);
...
struct ccn_node *DGFTrte(struct ccn_node *node);
struct ccn_node *DGFTste(struct ccn_node *node);
struct ccn_node *DGFTchild(struct ccn_node *node);
struct ccn_node *DGFTrule(struct ccn_node *node);
struct ccn_node *DGFTfield(struct ccn_node *node);
struct ccn_node *DGFTpattern(struct ccn_node *node);
struct ccn_node *DGFTraw_rule(struct ccn_node *node);
...
struct ccn_node *DGCHTrte(struct ccn_node *node);
struct ccn_node *DGCHTste(struct ccn_node *node);
struct ccn_node *DGCHTchild(struct ccn_node *node);
struct ccn_node *DGCHTrule(struct ccn_node *node);
struct ccn_node *DGCHTfield(struct ccn_node *node);
struct ccn_node *DGCHTpattern(struct ccn_node *node);
struct ccn_node *DGCHTraw_rule(struct ccn_node *node);
...
ccn_node *CPYrte(ccn_node *);
ccn_node *DELrte(ccn_node *);
ccn_node *CHKrte(ccn_node *);
...
ccn_node *CPYrule(ccn_node *);
ccn_node *DELrule(ccn_node *);
ccn_node *CHKrule(ccn_node *);
ccn_node *CPYfield(ccn_node *);
ccn_node *DELfield(ccn_node *);
ccn_node *CHKfield(ccn_node *);
ccn_node *CPYpattern(ccn_node *);
ccn_node *DELpattern(ccn_node *);
ccn_node *CHKpattern(ccn_node *);
ccn_node *CPYraw_rule(ccn_node *);
ccn_node *DELraw_rule(ccn_node *);
ccn_node *CHKraw_rule(ccn_node *);
